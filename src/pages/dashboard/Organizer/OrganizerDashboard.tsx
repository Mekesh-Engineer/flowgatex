...
export default function OrganizerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)] font-sans selection:bg-[var(--color-primary)] selection:text-white pb-12">
        ...
        >
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-primary)] rounded-2xl p-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link to="/organizer/notifications" className="text-xs text-[var(--color-primary)] font-bold hover:underline">View All</Link>
            </div>
